...
public class AddonsToolModel implements IUnbakedModel{
    private static final IUnbakedModel MODEL = new AddonsToolModel();

    public static final Map<UUID, Float> bowPull = new HashMap<>();

    private final ImmutableMap<String, String> textures;

    private AddonsToolModel() {
        textures = ImmutableMap.of();
    }

    private AddonsToolModel(ImmutableMap<String, String> textures) {
        this.textures = textures;
    }

    @Override
    public AddonsToolModel retexture(ImmutableMap<String, String> textures) {
        return new AddonsToolModel(textures);
    }

    @Override
    public AddonsToolModel process(ImmutableMap<String, String> customData) {
        return new AddonsToolModel(customData);
    }
...
//        SilentGear.log.info("Getting item part textures... what could go wrong?");
        for (ICoreTool item : AddonsModItems.toolClasses.values()) {
    ...
    public IBakedModel bake(ModelBakery bakery, Function<ResourceLocation, TextureAtlasSprite> spriteGetter, ISprite sprite, VertexFormat format) {
        ...
        return new AddonsToolModel.Baked(this, createQuadsMap(model, layerCount), format, Maps.immutableEnumMap(transformMap), new HashMap<>());
    }
    ...
    public static final class Loader implements ICustomModelLoader {
        ...
        public boolean accepts(@Nonnull ResourceLocation modelLocation) {
            boolean matchesPath = AddonsModItems.toolClasses.keySet().stream().anyMatch(s -> modelLocation.getPath().equals(s));
